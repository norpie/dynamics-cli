...
- **Tree Component**: expansion/collapse state, scrolloff, parent navigation (left arrow jumps to parent), table-tree variant with columns/borders, cached metadata (node_parents, node_depths, visible_order)
...
- **Text Input**: password masking, placeholder text, max length validation
